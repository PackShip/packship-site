                ...
                <div className="bg-white dark:bg-black/20 light:bg-white rounded-xl shadow-sm overflow-hidden">
                  <div className="p-4 sm:p-6 md:p-8">
                    ...
                    <Link
                      ...
                      className="group"
                    >
                      <h2 className="text-xl sm:text-2xl font-bold mb-3 group-hover:text-packship-purple-lite transition-colors">
                        PackShip v2: Why I Decided to Go Open Source from
                        Commercial
                      </h2>
                    </Link>
                    ...
                    <p className="text-gray-600 dark:text-white/70 light:text-gray-600 mb-6">
                      ...
                      wasn&apos;t made lightly, but I believe it&apos;s the
                      right path forward for the project and the community.
                      Here&apos;s the story behind this transition...
                    </p>
