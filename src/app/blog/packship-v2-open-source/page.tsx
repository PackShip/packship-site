        ...
        <div className="kontainer px-4 sm:px-6">
          <div className="row">
            <div className="max-w-3xl mx-auto">
              <Link
                href="/blog"
                className="inline-flex items-center text-packship-purple-lite hover:underline mb-6 sm:mb-8"
              >
                <svg
              ...
              <article>
                <header className="mb-6 sm:mb-8">
                  ...
                  <div className="flex items-center">
                    <div className="h-10 w-10 sm:h-12 sm:w-12 rounded-full overflow-hidden mr-3 sm:mr-4 bg-packship-purple-lite/20 flex items-center justify-center">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-6 w-6 sm:h-8 sm:w-8 text-packship-purple-lite"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                      >
                ...
                <div className="prose prose-sm sm:prose-base md:prose-lg dark:prose-invert max-w-none">
                  <p>
                    When I first launched PackShip as a commercial product, my
                    goal was to create a tool that would simplify the NPM
                    package lifecycle for developers. The response was
                    incredible, and I&apos;m grateful for all the support from
                  ...
                  <p>
                    ...
                    everyone. The decision to transition from a commercial
                    product to an open-source project wasn&apos;t made
                    overnight, but it&apos;s one I&apos;m incredibly excited
                    about.
                  </p>
                  ...
                  <p>
                    PackShip started as a solution to a problem I faced daily:
                    the tedious process of setting up, configuring, and
                    publishing NPM packages. What began as a personal tool
                    quickly evolved into something I believed could help the
                    broader developer community.
                  </p>

                  <p>
                    The commercial version of PackShip gained traction among
                    teams looking to streamline their package development
                    workflow. The feedback was invaluable, and it helped shape
                    the tool into what it is today.
                  </p>
                  ...
                  <ol>
                    <li>
                      ...
                      powerful software is built by communities, not
                      individuals. By opening up PackShip, we can harness the
                      collective creativity and expertise of developers
                      worldwide.
                    </li>
                    <li>
                      <strong>Accessibility:</strong> Tools that make
                      development easier should be available to everyone,
                      regardless of budget constraints. Open sourcing PackShip
                      removes financial barriers to entry.
                    </li>
                    <li>
                      <strong>Transparency:</strong> Open source fosters trust.
                      Users can see exactly what the code does, how it handles
                      their packages, and contribute improvements.
                    </li>
                    <li>
                      <strong>Education:</strong> PackShip can serve as a
                      learning resource for developers interested in package
                      management, automation, and CLI tool development.
                    </li>
                  </ol>
                  ...
                  <p>
                    Open source is all about community, and I invite you to be
                    part of PackShip&apos;s future. Here&apos;s how you can get
                    involved:
                  </p>
                  ...
                  <ul>
                    ...
                    <li>
                      Spread the word about PackShip in your developer
                      communities
                    </li>
                  </ul>

                  <p>
                    I&apos;m incredibly excited about this new chapter for
                    PackShip and can&apos;t wait to see what we&apos;ll build
