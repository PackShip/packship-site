    ...
    <section id="start-packshipping" className="py-24 relative">
      <div className="kontainer">
        <div className="row flex flex-col items-center gap-16">
          ...
          <div className="flex flex-col xl:flex-row w-full gap-8 max-w-4xl">
            <div
              data-aos="fade-up"
              className="feature-card flex flex-col dark:bg-black/20 light:bg-white/90 p-6 rounded-lg border dark:border-gray-800 light:border-gray-200 w-full xl:w-[40%]"
            >
            ...
            <div
              data-aos="fade-up"
              data-aos-delay="100"
              className="feature-card flex flex-col dark:bg-black/20 light:bg-white/90 p-6 rounded-lg border dark:border-gray-800 light:border-gray-200 w-full xl:w-[60%]"
            >
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 rounded-md bg-packship-purple-lite/20 flex items-center justify-center">
